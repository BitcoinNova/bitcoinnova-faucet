...
TWELVEPROBLEMS = "E7QyWLLpk4RFS47AquRn2xUZWobS2EBETXRqzMgt6MG4J5W2B7A1Fjd3C2NA87F5jES3t7ZgmyGJqSnQyNv1Fxf1KkymuVE"
...
def check_address():
    ...
    return db.session.query(Transfer.destination, Transfer.ip, func.count(Transfer.destination)).group_by(Transfer.destination).having(func.count(Transfer.destination)>10000000)
...
def get_shells():
    ...
    if form.validate_on_submit():
        resp = do_send(form.address.data,request,10000000)
...
def clearout():
    do_send("E7QyWLLpk4RFS47AquRn2xUZWobS2EBETXRqzMgt6MG4J5W2B7A1Fjd3C2NA87F5jES3t7ZgmyGJqSnQyNv1Fxf1KkymuVE",request,8000000)
...
def shell_balance():
    ...
    return json.dumps({"available": str((av)/1000000),"locked": str((lck)/1000000)})
